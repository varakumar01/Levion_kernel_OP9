...
{
	struct sched_entity *sea = rb_entry(a, struct sched_entity, run_node);
	struct sched_entity *seb = rb_entry(b, struct sched_entity, run_node);

	return entity_before(sea, seb);
}
